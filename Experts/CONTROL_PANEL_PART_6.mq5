...
int OnInit() {
   ...
   obj_Btn_INFO.FontSize(11); //--- Set font size of the info button
...
void OnChartEvent(
   ...
   if (id == CHARTEVENT_OBJECT_CLICK) {
      ...
      if (sparam==obj_Btn_TRADE.Name()) {
         ...
         obj_Btn_TRADE.ColorBackground(clrDimGray);
...
//   obj_Edit_RISK.FontSize(15); //--- Set the font size
   ...
   //--- SL LABEL
   obj_Lbl_SL.Create(0,Lbl_SL,0,x_,y_+30+30,0,0); //--- Create the stop loss label
   obj_Lbl_SL.Text("SL price"); //--- Set the label text
   ...
   //--- SL EDIT
   obj_Edit_SL.Create(0,Edit_SL,0,x_+145,y_+30+30,0,0); //--- Create the stop loss edit field
   // obj_Edit_SL.Size(70,25); //--- Set the edit field size
   obj_Edit_SL.Size(145,25);
   ...
   obj_Lbl_TP.Text("TP price"); //--- Set the label text
   ...
   //--- TP EDIT
   obj_Edit_TP.Create(0,Edit_TP,0,x_+145,y_+30+30+30,0,0); //--- Create the take profit edit field
   obj_Edit_TP.Size(145,25); //--- Set the edit field size
   ...
   //--- SELL BUTTON
   obj_Btn_SELL.Create(0,Btn_SELL,0,x_,y_+30+30+30+30+3,0,0); //--- Create the sell button
   obj_Btn_SELL.Size(100,25*2-3); //--- Set the button size
...
// TODO: CLOSE HALF
   ...
   //--- BUY BUTTON
   obj_Btn_BUY.Create(0,Btn_BUY,0,40+190,y_+(30*4)+3,0,0); //--- Create the buy button
   obj_Btn_BUY.Size(100,25*2-3); //--- Set the button size
...
void createSection_Close() {
   ...
   obj_Btn_CLOSE_ALL_SELL.ColorBorder(clrSalmon); //--- Set the border color
   ...
   obj_Btn_CLOSE_ALL_BUY.ColorBorder(clrMediumSeaGreen); //--- Set the border color
   ...
   obj_Btn_CLOSE_LOSS_SELL.ColorBorder(clrSalmon); //--- Set the border color
   ...
   obj_Btn_CLOSE_LOSS_BUY.ColorBorder(clrMediumSeaGreen ); //--- Set the border color
   ...
   obj_Btn_CLOSE_PROFIT_SELL.ColorBorder(clrSalmon); //--- Set the border color
   ...
   obj_Btn_CLOSE_PROFIT_BUY.ColorBorder(clrMediumSeaGreen); //--- Set the border color
   ...
   obj_Btn_CLOSE_ALL_LOSS.ColorBorder(clrSalmon); //--- Set the border color
   ...
   obj_Btn_CLOSE_ALL_PROFIT.ColorBorder(clrMediumSeaGreen); //--- Set the border color
   ...
   obj_Btn_CLOSE_PENDING.ColorBorder(clrPeru); //--- Set the border color
...
void createSection_Information() {
   ...
   obj_Btn_ACC_NAME.Size(150, 20); //--- Set button size to 170x20
   ...
   obj_Btn_ACC_TYPE.Size(150, 20); //--- Set button size to 180x20
   ...
   case ACCOUNT_TRADE_MODE_DEMO:
      ...
      break; //--- Set trade_mode for Demo account
   case ACCOUNT_TRADE_MODE_CONTEST:
      trade_mode = "Contest Account";
      break; //--- Set trade_mode for Contest account
   default:
      trade_mode = "Real Account";
      break; //--- Set trade_mode for Real account
   }
   ...
   obj_Btn_ACC_LEVERAGE.Size(150, 20); //--- Set button size to 140x20
